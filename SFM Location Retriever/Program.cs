...
namespace SFM_Location_Retriever
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            sourceFilmmakerPaths = FindSFM(RemoveInvalidPaths(steamGameDirs));
        ...
        /// <returns></returns>
        private static List<string> RemoveInvalidPaths(List<string> steamGameDirs)
        {
        ...
        /// <returns></returns>
        private static List<string> FindSFM(List<string> steamGameDirs)
        {
            List<string> sourceFilmmakerPaths = new List<string>();
